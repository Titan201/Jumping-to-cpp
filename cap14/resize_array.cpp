...
int main ()
{
    ...
    while (val != 0)
    {
        ...
        {
            // Now all we need to do is implement growArray. Notice that 
            // we need to pass in size as a pointer since we need to keep 
            // track of the size of the array as it grows! 
            p_values = growArray( p_values, & size); //Remember that p_values is a value not an address 
        }
...
int *growArray (int* p_values, int *size)
{
    *size *=2; // This multiply size by 2 
